...
<head>
    ...
    <!-- MAPS -->
    <script type="text/javascript" src="<?php echo SITE_PATH ?>view/assets/js/apikeys.js"></script>
    <script type="text/javascript" src="<?php echo SITE_PATH ?>modules/contact/view/js/contact.js"></script>

    <!-- SEARCH -->
    <script type="text/javascript" src="<?php echo SITE_PATH ?>modules/search/view/js/search.js"></script>

    <!-- CHECK SESSION -->
    <script type="text/javascript" src="<?php echo SITE_PATH ?>view/assets/js/checksession.js"></script>
    
    <!-- LOGIN -->
    <script type="text/javascript" src="<?php echo SITE_PATH ?>modules/login/view/js/login.js"></script>

    <!-- ACTIVITY LOGIN -->
    <script type="text/javascript" src="<?php echo SITE_PATH ?>modules/login/view/js/activity.js"></script>

    <!-- FAVORITES -->
    <script type="text/javascript" src="<?php echo SITE_PATH ?>modules/favorites/view/js/fav.js"></script>

    <!-- CART -->
    <script type="text/javascript" src="<?php echo SITE_PATH ?>modules/cart/view/js/cart.js"></script>

    <!-- SEND MAILGUN -->
    <script type="text/javascript" src="<?php echo SITE_PATH ?>modules/contact/view/js/send_email_contact.js"></script>
