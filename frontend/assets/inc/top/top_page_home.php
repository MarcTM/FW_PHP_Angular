...
<head>
    ...
    <!-- HOME -->
    <script src="<?php echo SITE_PATH ?>modules/home/view/js/homepage.js"></script>
    ...
    <!-- SOCIAL LOGIN -->
    <script type="text/javascript" src="<?php echo SITE_PATH ?>modules/login/view/js/sociallogin.js"></script>
    <script src="https://www.gstatic.com/firebasejs/3.5.2/firebase.js"></script>
    <script type="text/javascript" src="<?php echo SITE_PATH ?>view/assets/js/apikeys_firebase.js"></script>
